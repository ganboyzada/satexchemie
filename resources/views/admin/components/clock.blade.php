{{--<div class="col-xl-4 col-lg-4 col-md-6">--}}
                <div class="card mb-0 h-100">
                  <div class="mobile-clock-widget h-100" style="background-image: url(./assets/images/mobile-clock-wallpaper.jpg);">
                    <div class="bg-svg">
                    ...
                    <div>
                      ...
                      <div class="date f-24 mb-2" id="date"><span id="monthDay"></span><span id="year">{{ date('j F, Y') }}</span></div>
                      <div>
