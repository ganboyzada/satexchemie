<div class="card-header">
                            ...
                            <div class="card-body admin-list">
                                <form class="theme-form store-form" action="{{ route('admin.partners.update', $item->id) }}"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                        <input class="form-control" type="text" value="{{ $item->name }}" placeholder="nümunə" name="name" data-bs-original-title="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                        <input class="form-control" type="text" value="{{ $item->link }}" placeholder="https://" name="link" data-bs-original-title="" title="">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            <img src="{{ asset($item->img) }}" height="60">
                                        </div>
                                    </div>
