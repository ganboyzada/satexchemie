    ...
    <div class="row">
        <div class="col-md-8">
                        ...
                        <div class="card-header">
                            <h5>Toplu şəkildə fotolar yüklə</h5><span>Aşağıdakı tələb olunan xanaları doldurun və 'Yadda saxla' düyməsini sıxın.</span>
                        </div>
                        <div class="card-body admin-list">
                            <form class="theme-form store-form" action="{{ route('admin.photos.bulk_upload_store') }}" 
