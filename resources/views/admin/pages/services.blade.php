    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
                    ...
                    <div class="table-responsive admin-list">
                        ...
                        <thead>
                            <tr>
                            <th scope="col">#</th>
                            <th scope="col">Xidmət adı</th>
                            <th scope="col">Şəkil</th>
                            <th scope="col">Əməliyyatlar</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach(\App\Models\Service::get() as $k=>$service)
                            <tr>
                                <th scope="row">{{ $k+1 }}</th>
                                <td>{{ $service->name_az }}</td>
                                <td><img src="{{ asset($service->img) }}" height="40px" alt=""></td>
                                <td>
                                    <div class="btn-group btn-group-pill">
                                        ...
                                        --}}
                                        <a class="btn btn-light" data-type="services" data-btn="edit" data-id="{{ $service->id }}" data-bs-original-title="" title=""><i data-feather='edit' height="18"></i></a>
        ...
        <div class="col-sm-12 col-md-6">
                        ...
                        <div class="card-body admin-list">
                            <form class="theme-form store-form" action="{{ route('admin.services.store') }}" 
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                    <input class="form-control" type="text" placeholder="nümunə" name="name_{{ $lang }}">
                                    </div>
                                </div>
                                @endforeach
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                    <textarea class="form-control" type="text" placeholder="nümunə" name="desc_{{ $lang }}"></textarea>
                                    </div>
                                </div>
                                @endforeach
