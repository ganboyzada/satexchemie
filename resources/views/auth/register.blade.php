            ...
            {{--
              ...
              <div class="login-main"> 
                ...
                @csrf
                  ...
                  <div class="form-group">
                    <label class="col-form-label">Parol təsdiqi</label>
                    <div class="form-input position-relative">
                  ...
                  <div class="form-group mb-0">
                    ...
                    --}}
                    <button class="btn btn-primary btn-block w-100" type="submit">Hesabı yarat</button>
                  </div>
                  {{--
                  ...
                  --}}
                  <p class="mt-4 mb-0 text-center">Artıq adminsiniz?<a class="ms-2" href="{{ route('login') }}">Daxil olun</a></p>
                </form>
              </div>
            </div>
          </div>
